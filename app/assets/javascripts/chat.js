...
var ready = function () {
    ...
    chatBox = {
        ...
        createChatBox: function (conversation_id, minimizeChatBox) {
            console.log("inside début createChatBox")
            if ($("#chatbox_" + conversation_id).length > 0) {
                console.log("inside createChatBox conversation_id length")
                ...
                $("#chatbox_" + conversation_id + " .chatboxtextarea").focus();
                return;
                console.log("inside fin createChatBox")
            }
